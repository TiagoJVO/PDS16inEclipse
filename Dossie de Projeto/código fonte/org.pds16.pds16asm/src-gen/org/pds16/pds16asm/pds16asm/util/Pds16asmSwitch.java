...
public class Pds16asmSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        OperationsWithThreeRegisters operationsWithThreeRegisters = (OperationsWithThreeRegisters)theEObject;
        T result = caseOperationsWithThreeRegisters(operationsWithThreeRegisters);
        if (result == null) result = caseAdd(operationsWithThreeRegisters);
        if (result == null) result = caseSub(operationsWithThreeRegisters);
        if (result == null) result = caseAnl(operationsWithThreeRegisters);
        if (result == null) result = caseOrl(operationsWithThreeRegisters);
        if (result == null) result = caseXrl(operationsWithThreeRegisters);
        if (result == null) result = caseAritmetica(operationsWithThreeRegisters);
        if (result == null) result = caseLogica(operationsWithThreeRegisters);
        if (result == null) result = caseInstructions(operationsWithThreeRegisters);
        if (result == null) result = caseStatement(operationsWithThreeRegisters);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case Pds16asmPackage.REGISTER:
      {
        ...
        if (result == null) result = caseAdd(register);
        if (result == null) result = caseSub(register);
        if (result == null) result = caseBasedIndexed(register);
        if (result == null) result = caseAritmetica(register);
        if (result == null) result = caseLdBasedIndexed(register);
        if (result == null) result = caseStBasedIndexed(register);
        if (result == null) result = caseLoad(register);
        if (result == null) result = caseStore(register);
        if (result == null) result = caseInstructions(register);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Operations With Three Registers</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Operations With Three Registers</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseOperationsWithThreeRegisters(OperationsWithThreeRegisters object)
  {
    return null;
  }
