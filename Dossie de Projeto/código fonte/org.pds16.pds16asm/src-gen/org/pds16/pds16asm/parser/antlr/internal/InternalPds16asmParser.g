	...
	(
		(
			...
			(
				...
				{
					$current = $this_OperationsWithThreeRegisters_5.current;
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		(
			...
			{
				$current = $this_Register_8.current;
				afterParserOrEnumRuleCall();
			}
		)
	)
...
@after {
	...
	(
		...
		(
			...
			{
				$current = $this_OperationsWithThreeRegisters_7.current;
				afterParserOrEnumRuleCall();
			}
		)
		    |
		(
			...
			{
				$current = $this_Register_10.current;
				afterParserOrEnumRuleCall();
			}
		)
	)
...
@after {
	...
	(
		...
		{
			$current = $this_OperationsWithThreeRegisters_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleOperationsWithThreeRegisters returns [EObject current=null]:
	...
	{ $current=$iv_ruleOperationsWithThreeRegisters.current; }
	EOF;

// Rule OperationsWithThreeRegisters
ruleOperationsWithThreeRegisters returns [EObject current=null]
@init {
	enterRule();
}
@after {
