...
public class Pds16asmAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected Pds16asmSwitch<Adapter> modelSwitch =
    new Pds16asmSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseOperationsWithThreeRegisters(OperationsWithThreeRegisters object)
      {
        return createOperationsWithThreeRegistersAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.pds16.pds16asm.pds16asm.OperationsWithThreeRegisters <em>Operations With Three Registers</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createOperationsWithThreeRegistersAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.pds16.pds16asm.pds16asm.Register <em>Register</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
