...
public interface Pds16asmFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Operations With Three Registers</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Operations With Three Registers</em>'.
   * @generated
   */
  OperationsWithThreeRegisters createOperationsWithThreeRegisters();
