...
public class Pds16asmSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (rd=Register rm=Register const4=Const4OrLabel (sin=INT | sin=HEX | sin=OCT | sin=BIN | sin=CHAR))
	 */
	...
	protected void sequence_OperationsWithTreeRegisters(ISerializationContext context, OperationsWithTreeRegisters semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getOperationsWithTreeRegistersAccess().getRdRegisterParserRuleCall_0_0(), semanticObject.getRd());
		feeder.accept(grammarAccess.getOperationsWithTreeRegistersAccess().getRmRegisterParserRuleCall_2_0(), semanticObject.getRm());
		feeder.accept(grammarAccess.getOperationsWithTreeRegistersAccess().getRnRegisterParserRuleCall_4_0(), semanticObject.getRn());
		feeder.finish();
	}
