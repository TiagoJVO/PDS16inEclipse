...
public class Pds16asmSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     (rule start) (ambiguity) rd=Register
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) value='LR'
	 *     (rule start) (ambiguity) value='PC'
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) idValue+=ID
	 *     (rule start) (ambiguity) numericValue+=BIN
	 *     (rule start) (ambiguity) numericValue+=CHAR
	 *     (rule start) (ambiguity) numericValue+=HEX
	 *     (rule start) (ambiguity) numericValue+=INT
	 *     (rule start) (ambiguity) numericValue+=OCT
	 */
