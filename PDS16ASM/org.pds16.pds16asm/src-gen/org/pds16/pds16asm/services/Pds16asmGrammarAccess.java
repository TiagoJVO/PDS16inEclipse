...
public class Pds16asmGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class REGISTERSElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cR0Keyword_0 = (Keyword)cAlternatives.eContents().get(0);
		private final Keyword cR1Keyword_1 = (Keyword)cAlternatives.eContents().get(1);
		private final Keyword cR2Keyword_2 = (Keyword)cAlternatives.eContents().get(2);
		private final Keyword cR3Keyword_3 = (Keyword)cAlternatives.eContents().get(3);
		private final Keyword cR4Keyword_4 = (Keyword)cAlternatives.eContents().get(4);
		private final Keyword cR5Keyword_5 = (Keyword)cAlternatives.eContents().get(5);
		private final Keyword cR6Keyword_6 = (Keyword)cAlternatives.eContents().get(6);
		private final Keyword cR7Keyword_7 = (Keyword)cAlternatives.eContents().get(7);
		private final Keyword cLRKeyword_8 = (Keyword)cAlternatives.eContents().get(8);
		private final Keyword cPSWKeyword_9 = (Keyword)cAlternatives.eContents().get(9);
		private final Keyword cPCKeyword_10 = (Keyword)cAlternatives.eContents().get(10);
		...
		//'r0'
		public Keyword getR0Keyword_0() { return cR0Keyword_0; }
		
		//'r1'
		public Keyword getR1Keyword_1() { return cR1Keyword_1; }
		
		//'r2'
		public Keyword getR2Keyword_2() { return cR2Keyword_2; }
		
		//'r3'
		public Keyword getR3Keyword_3() { return cR3Keyword_3; }
		
		//'r4'
		public Keyword getR4Keyword_4() { return cR4Keyword_4; }
		
		//'r5'
		public Keyword getR5Keyword_5() { return cR5Keyword_5; }
		
		//'r6'
		public Keyword getR6Keyword_6() { return cR6Keyword_6; }
		
		//'r7'
		public Keyword getR7Keyword_7() { return cR7Keyword_7; }
		
		//'LR'
		public Keyword getLRKeyword_8() { return cLRKeyword_8; }
		
		//'PSW'
		public Keyword getPSWKeyword_9() { return cPSWKeyword_9; }
		
		//'PC'
		public Keyword getPCKeyword_10() { return cPCKeyword_10; }
	}
