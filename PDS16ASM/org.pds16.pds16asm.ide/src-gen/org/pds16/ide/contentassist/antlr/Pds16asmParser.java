		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getWordAccess().getValue1Alternatives_1_0(), "rule__Word__Value1Alternatives_1_0");
					...
					put(grammarAccess.getConstOrLabelAccess().getGroup(), "rule__ConstOrLabel__Group__0");
					...
					put(grammarAccess.getByteAccess().getValue1Assignment_1(), "rule__Byte__Value1Assignment_1");
					put(grammarAccess.getWordAccess().getValue1Assignment_1(), "rule__Word__Value1Assignment_1");
					...
					put(grammarAccess.getConstOrLabelAccess().getNumberAssignment_1_0(), "rule__ConstOrLabel__NumberAssignment_1_0");
					put(grammarAccess.getConstOrLabelAccess().getLabelAssignment_1_1(), "rule__ConstOrLabel__LabelAssignment_1_1");
