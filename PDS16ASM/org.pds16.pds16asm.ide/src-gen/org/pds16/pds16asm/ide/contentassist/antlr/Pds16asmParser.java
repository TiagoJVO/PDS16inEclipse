		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getByteAccess().getNumberAlternatives_1_0_0(), "rule__Byte__NumberAlternatives_1_0_0");
					put(grammarAccess.getByteAccess().getNumberAlternatives_1_1_1_0(), "rule__Byte__NumberAlternatives_1_1_1_0");
					put(grammarAccess.getWordAccess().getAlternatives_1_0(), "rule__Word__Alternatives_1_0");
					put(grammarAccess.getWordAccess().getNumberAlternatives_1_0_1_0(), "rule__Word__NumberAlternatives_1_0_1_0");
					put(grammarAccess.getWordAccess().getAlternatives_1_1_1(), "rule__Word__Alternatives_1_1_1");
					put(grammarAccess.getWordAccess().getNumberAlternatives_1_1_1_1_0(), "rule__Word__NumberAlternatives_1_1_1_1_0");
					...
					put(grammarAccess.getAsciiAccess().getValueAssignment_1_0(), "rule__Ascii__ValueAssignment_1_0");
					put(grammarAccess.getAsciizAccess().getValueAssignment_1_0(), "rule__Asciiz__ValueAssignment_1_0");
					put(grammarAccess.getByteAccess().getNumberAssignment_1_0(), "rule__Byte__NumberAssignment_1_0");
					put(grammarAccess.getByteAccess().getNumberAssignment_1_1_1(), "rule__Byte__NumberAssignment_1_1_1");
					put(grammarAccess.getWordAccess().getValueAssignment_1_0_0(), "rule__Word__ValueAssignment_1_0_0");
					put(grammarAccess.getWordAccess().getNumberAssignment_1_0_1(), "rule__Word__NumberAssignment_1_0_1");
					put(grammarAccess.getWordAccess().getValueAssignment_1_1_1_0(), "rule__Word__ValueAssignment_1_1_1_0");
					put(grammarAccess.getWordAccess().getNumberAssignment_1_1_1_1(), "rule__Word__NumberAssignment_1_1_1_1");
