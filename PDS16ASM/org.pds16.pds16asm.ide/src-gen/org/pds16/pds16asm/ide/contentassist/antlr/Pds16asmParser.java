		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBssAccess().getValueAssignment(), "rule__Bss__ValueAssignment");
					put(grammarAccess.getDataAccess().getValueAssignment(), "rule__Data__ValueAssignment");
					put(grammarAccess.getEndAccess().getValueAssignment(), "rule__End__ValueAssignment");
					...
					put(grammarAccess.getByteAccess().getNumbersAssignment_1_0_0(), "rule__Byte__NumbersAssignment_1_0_0");
					put(grammarAccess.getByteAccess().getSAssignment_1_0_1(), "rule__Byte__SAssignment_1_0_1");
					put(grammarAccess.getByteAccess().getNumbersAssignment_1_1_1_0(), "rule__Byte__NumbersAssignment_1_1_1_0");
					put(grammarAccess.getByteAccess().getSAssignment_1_1_1_1(), "rule__Byte__SAssignment_1_1_1_1");
					...
					put(grammarAccess.getEquAccess().getValue1Assignment_1(), "rule__Equ__Value1Assignment_1");
					put(grammarAccess.getEquAccess().getValue2Assignment_3(), "rule__Equ__Value2Assignment_3");
